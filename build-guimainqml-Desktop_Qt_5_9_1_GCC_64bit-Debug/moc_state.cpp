...
QT_MOC_LITERAL(1, 6, 23), // "onEnteredWithObjectName"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 10) // "objectName"

    },
    "State\0onEnteredWithObjectName\0\0"
    "objectName"
};
...
void State::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onEnteredWithObjectName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&State::onEnteredWithObjectName)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void State::onEnteredWithObjectName(QString _t1)
{
