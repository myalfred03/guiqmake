...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        toolButton = new QToolButton(gridWidget);
        ...
        radioButton = new QRadioButton(gridWidget);
