...
public:
    ...
    void setupUi(QMainWindow *ROSGUI)
    {
        ...
        gridLayout_6->setContentsMargins(5, -1, -1, 8);
        ...
        gridLayout_2->addWidget(label_59, 12, 2, 1, 1);
        ...
        gridLayout_2->addWidget(fkRoll, 12, 1, 1, 1);

        label_30 = new QLabel(gridGroupBox2);
        label_30->setObjectName(QStringLiteral("label_30"));

        gridLayout_2->addWidget(label_30, 4, 2, 1, 1);

        label_58 = new QLabel(gridGroupBox2);
        label_58->setObjectName(QStringLiteral("label_58"));
        label_58->setFont(font1);

        gridLayout_2->addWidget(label_58, 11, 2, 1, 1);
        ...
        gridLayout_2->addWidget(fkX, 2, 1, 1, 1);
        ...
        gridLayout_2->addWidget(fkZ, 6, 1, 1, 1);
        ...
        gridLayout_2->addWidget(fkPitch, 11, 1, 1, 1);
        ...
        gridLayout_2->addWidget(label_55, 12, 0, 1, 1);
        ...
        gridLayout_2->addWidget(label_57, 9, 2, 1, 1);
        ...
        gridLayout_2->addWidget(fkY, 4, 1, 1, 1);
        ...
        gridLayout_2->addWidget(fkYaw, 9, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *ROSGUI)
    {
        ...
        comboBox->setItemText(1, QApplication::translate("ROSGUI", "Show only Robot", Q_NULLPTR));
        comboBox->setItemText(2, QApplication::translate("ROSGUI", "Show Robot with Axes", Q_NULLPTR));
        comboBox->setItemText(3, QApplication::translate("ROSGUI", "Show Axes with Names", Q_NULLPTR));
