...
public:
    ...
    void retranslateUi(QMainWindow *SecondWindow)
    {
        ...
        pushButton->setText(QApplication::translate("SecondWindow", "CLOSE", Q_NULLPTR));
...
"Dado que son las variables articulares las que pueden ser le\303\255das directamente de los correspondientes sensores por la unidad de control del robot, el modelo cinem\303\241tico directo ser\303\241n utilizado por \303\251ste, entre otros fines, para presentar al usuario informaci\303\263n relativa a la localizaci\303\263n del extremo del robot.", Q_NULLPTR));
