...
public:
    ...
    {
        thirdwindow->setWindowTitle(QApplication::translate("thirdwindow", "MainWindow", Q_NULLPTR));
        label_2->setText(QString());
        pushButton->setText(QApplication::translate("thirdwindow", "CLOSE", Q_NULLPTR));
...
"procedimiento de obtenci\303\263n de las ecuaciones fuertemente dependiente de la configuraci\303\263n del robot.", Q_NULLPTR));
    } // retranslateUi
